...
const stripePromise = loadStripe('pk_test_51MFhV3SEpopow3NHWebaEqcdDHJtwgfMx3tIdtxugx4yCz1PLBQpETXXND2RnmF5nqN7ANcBTJafPfPexHg6sH2x00kX4PV6rU')
    ...
    <Row>
        <Col>
         <h1 className="pt-2 h3">Shopping cart</h1>
            {cart.length == 0 ? 
            <>
                <Alert variant="info">Shopping Cart is empty. Add products to your cart </Alert> <i className='fa fa-shopping-basket'></i> </> : 
