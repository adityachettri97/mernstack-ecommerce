...
function ProductPage() {
  ...
  return (
    ...
    <Container className="pt-4" style={{position:'relative'}}>
        <Row>
            <Col lg={6}>
                <AliceCarousel mouseTracking items={images} controlsStrategy="alternate"></AliceCarousel>
            </Col>
            <Col lg={6} className="pt-4">
                ...
                {isSuccess && <ToastMessage bg="info" title="Added to cart" body={`${product.name} is in your card`}/>}
            </Col>
        </Row>
        <div className="my-4">
